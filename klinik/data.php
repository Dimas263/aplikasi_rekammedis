                        ...
                        <div class="card-body">
                            ...
                            <table id="datatables-button" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="delete.php?id=<?=$data['id_klinik']?>" onclick="return confirm('apakah anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm text-white"><i class="icon icon-trash"></i></a>
                                    </td>
                                    <?php
                                    }
                                    ?>
