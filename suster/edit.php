                                    ...
                                    <div class="body">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="hidden" name="id" value="<?=$data['id_suster']?>">
                                                        <input type="text" name="nama_suster" id="nama_suster" class="form-control" value="<?=$data['nama_suster']?>" autofocus required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="jenis_suster" id="jenis_suster" class="form-control" value="<?=$data['jenis_suster']?>" autofocus required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
