                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <form action="proses " method="post">
                                            <div class="form-group" style="margin-top:15px;" >
                                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Dokter" required autofocus>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="spesialis" id="spesialis" class="form-control" placeholder="Spesialis" required autofocus>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <input type="date" name="praktek" id="praktek" value="<?=date('Y-m-d')?>" class="form-control" required>
                                            </div>

                                            <div class="form-group">
                                                <textarea name="jadwal" id="jadwal" class="form-control" placeholder="Jadwal Jaga" required></textarea>
                                            </div>

                                            <br/>
                                            <div class="form-group" align="center">
                                                <a href="data " class="btn btn-light" style="background-color: #f4d35e;color : #1e2425;font-weight:bold;">&nbsp;Batal&nbsp;&nbsp;</a>
